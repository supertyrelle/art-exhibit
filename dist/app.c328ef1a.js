...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"img/cta-ill/cta-ill-1.png":[function(require,module,exports) {
module.exports = "/cta-ill-1.ed2f0bd9.png";
},{}],"img/cta-ill/cta-ill-2.png":[function(require,module,exports) {
module.exports = "/cta-ill-2.137f74f7.png";
},{}],"img/cta-ill/cta-ill-3.png":[function(require,module,exports) {
module.exports = "/cta-ill-3.2ad889ae.png";
},{}],"img/cta-ill/cta-ill-4.png":[function(require,module,exports) {
module.exports = "/cta-ill-4.a73588d9.png";
},{}],"img/cta-ill/cta-ill-5.png":[function(require,module,exports) {
...
var _ctaIll = _interopRequireDefault(require("./img/cta-ill/cta-ill-1.png"));

var _ctaIll2 = _interopRequireDefault(require("./img/cta-ill/cta-ill-2.png"));

var _ctaIll3 = _interopRequireDefault(require("./img/cta-ill/cta-ill-3.png"));

var _ctaIll4 = _interopRequireDefault(require("./img/cta-ill/cta-ill-4.png"));

var _ctaIll5 = _interopRequireDefault(require("./img/cta-ill/cta-ill-5.png"));
...
function home() {
  function homeContent() {
    ...
    ctaContent.setAttribute("class", 'cta-content col-fs'); // call to action title

    var ctaTitle = document.createElement('h1');
    ctaTitle.textContent = "There's something about Art that moves us."; // call to action subtitle

    var ctaSub = document.createElement('p');
    ctaSub.textContent = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum vitae est quis.'; // call to action exhibit dates

    var ctaExDates = document.createElement('h3');
    ctaExDates.textContent = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum vitae est quis.'; // call to action button
